# Migration `20200710215224-agregando-estado-a-tipo-producto`

This migration has been generated by Andres Baldarrago at 7/10/2020, 9:52:25 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "public"."TipoPago" ADD COLUMN "estado" boolean  NOT NULL DEFAULT true;
```
...
migration 20200710011936-agregando-rol-al-usuario..20200710215224-agregando-estado-a-tipo-producto
--- datamodel.dml
+++ datamodel.dml
@@ -1,167 +1,168 @@
-datasource db {
